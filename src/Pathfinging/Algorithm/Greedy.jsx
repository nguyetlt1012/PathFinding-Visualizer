...
export function Greedy(arr, startNode, finishNode) {
    const visitedNodesInOrder = [];
    startNode.distance=dis(startNode, finishNode);
    startNode.isVisited=true;
    // visitedNodesInOrder.push(startNode);
    let unvisitedNodes = getAllNodes(arr)
    ...
    //   unvisitedNodes = getUnvisitedNeighbors(closest, arr, finishNode);
    //   n--;
    ...
    while (!!unvisitedNodes){
        ...
        if(closest=== undefined) return visitedNodesInOrder;
        closest.isVisited = true;
        visitedNodesInOrder.push(closest);
  ...
  function update(node, arr,finishNode) {
    ...
    for (const neighbor of unvisitedNeighbors) {
      neighbor.distance = dis(neighbor, finishNode);
